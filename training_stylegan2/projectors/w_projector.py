...
def project(
    ...
    w_samples = G.get_latent(jt.array(z_samples))  # [N, L, C]
    ...
    optimizer = jt.nn.Adam([w_opt] + list(noise_bufs.values()), betas=(0.9, 0.999),
    ...
    for step in tqdm(range(num_steps)):
        ...
        synth_images, _ = G([ws], input_is_latent=True, randomize_noise=False)
